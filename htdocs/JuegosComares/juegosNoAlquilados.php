...
<html lang="en">
    ...
    <body class="d-flex justify-content-center">
        <div class="container row pt-3">
            ...
            <h2 class="text-center py-4">Juegos no alquilados</h2>
            <?php
            if (isset($_SESSION['nombre'])) {
                $juegos = ControladorJuego::recuperarTodosNoAlquilados();
                ...
                if ($juegos) {
                    ...
                    <div class="alert alert-danger row justify-content-center gap-2">
                        ...
                        <span class="text-center fw-bold h4">No hay ningun juego disponible en estos momentos</span>
                        <a href="juegosAlquilados.php" class="d-flex justify-content-center fw-bold h4 text-danger">Ver que juegos estan alquilados</a>
